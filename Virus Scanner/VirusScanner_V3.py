...
def print_hash(str):
    with open(file,"rb") as f:
        ...
        if sha256_hash.hexdigest() in hashs_to_check:
            #if a generated hash is in hashs_to_check (= if our Test File is inside the directory we´re inspecting)
            print("Warning!")
        else:
            pass
...
##To do
##V3
##malware hashes runterladen (API)
##https://onlinehelp.opswat.com/mdcloud/Top_infected_hashes.html
##https://www.nist.gov/itl/ssd/software-quality-group/national-software-reference-library-nsrl (fortgeschritten)
##https://virusshare.com/hashes.4n6
##https://www.owasp.org/index.php/OWASP_File_Hash_Repository
##save hashes to file and read them from script
##Dowloads scannen
##generate GUI Alert if hash matches
